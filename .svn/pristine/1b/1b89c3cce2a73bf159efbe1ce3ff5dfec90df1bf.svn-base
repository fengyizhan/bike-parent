...
public class VehicleController {
	...
	public Map<String, Long> getOnlineCount() throws Exception {
		...
		lowpowers = setOperator.size(RedisKey.VEHICLES_LOWPOWER);
		usings = setOperator.size(RedisKey.VEHICLES_USING);
		
		result.put("onlines", onlines);
		result.put("offlines", offlines);
		result.put("lowpowers", lowpowers);
		result.put("usings", usings);
